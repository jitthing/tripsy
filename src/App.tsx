...
function Workspace({ session }: { session: Session }) {
  ...
  return <main className="app-shell production-shell">
    ...
    {view === 'inbox' ? <Inbox trips={trips} notify={notify} /> : !activeTripID || !detail ? <EmptyTrips onCreate={() => setSheet('trip')} /> : <>
